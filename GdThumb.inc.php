...
class GdThumb extends ThumbBase {
    ...
    /**
     * Resize image fixed dimensions from option
     * Author : NILE
     */
    public function fixedresize($maxWidth = 0, $maxHeight = 0) {
        ...
        imagecopyresampled(
                $this->workingImage, $this->oldImage, 0, 0, 0, 0, $this->maxWidth, $this->maxHeight, $this->currentDimensions['width'], $this->currentDimensions['height']
        );
